# Javascript source code to build a Google Maps Widget that can be integrated into IPython Notebooks and used to work with Google Earth Engine.
# Code was written and freely provided by Tyler Erickson, Goolge Inc.
%%javascript
